...
Unfortunately, working out the algebra and solving for $\vec{\pmb{V}}$ is quite annoying. If there are number, I acutally recommend to stay with the symbols until the very last step. 
...
One rant is with exam cheat sheets. The intention is good--recuding our memorization. However, creating a cheat sheet often becomes another form of brute work. You have to admit that copying down every proof instead of trying to fully understand the derivation is easier and faster during prepration, and it's definitely much faster at the exam. Having more time and harder problems would reduce the reward to such practices. However, given the current stands, although I don't like cheat sheets, I still take full advantage of it...
...
Yes, after surviving an intensive 15-week brain workout, I can confirm the horror, but it's definitely managable with the correct approach.
...
I can confirm that the labs are pretty...easy, with clear instructions, expecatations, and hits.

Most problems are fair-game coding problems. Not much Data Strucutres background needed. You don't need to be a competitive programmer. 
...
- Exam 3 is focused on multiprocessing and the internet, which actually makes it easiter to prepare. No need to remember to boiler plate, but be sure to remember the structure of all Jae's codes.
...
In fact, this course is perfect in every aspect: the instructor, TAs, CLAC, lecutres, labs, exams, and grading. You may not get the result you want, but you can't say anything wrong about its design and content. It is *that* good. I thoroughly enjoyed a dense portion of it--the only exceptions being the three (actually 6) instants when exam solutions/scores are released. 
