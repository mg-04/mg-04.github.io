...
for i, point in enumerate(points):
    _, idx = tree.query(point, k=k+1)  # k+1 to include itself
...
Now add the cursors to where slope = -1. I have calculated the dy/dx and approximated where it's -1, but I don't we just 摆烂 and eyeball it  
![1738644178288](/images/osc/1738644178288.png)  
Looks pretty pretty! (and the graders won't care if I 摆烂 or not)
...
Feed the above in our KNN smoothener, and we get the result below:  
