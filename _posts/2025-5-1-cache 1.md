...
- **Byte offset** (which byte in the word, blue): $log_2\frac{\mathrm{word\, size}}{\mathrm{byte\, size}} = log_2\frac{4B}{1B} = 2 \mathrm{bits}$
...
**Valid**: Each smaller block is a contiguous sub‐block of the larger one. Data is already present, and their tag remains the same. One old block‐offset bit (LSB) becomes a set‐index bit.
...
<div style="text-align: center;">
<img src="../images/teaching/fundies/ef068edd4d7cfd6e2a57f7a20080d55.jpg" alt="Description" width="90%" />
</div>
...
<div style="text-align: center;">
<img src="../images/teaching/fundies/c563e0a3d59b67bff4e0d065e430d4b.jpg" alt="Description" width="90%" />
</div>
